...
public class AvalibilityRepository {
    ...
    public int save(Avalibility avalibility) {
        ...
        return jdbcTemplate.update(sql, avalibility.getDoctor_id(), avalibility.getMon_startTime(),
                avalibility.getMon_endTime(),
    ...
    private static class AvalibilityRowMapper implements RowMapper<Avalibility> {
        ...
        public Avalibility mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            avalibility.setMon_startTime(
                    rs.getTime("Mon_startTime") != null ? rs.getTime("Mon_startTime").toLocalTime() : null);
            avalibility
                    .setMon_endTime(rs.getTime("Mon_endTime") != null ? rs.getTime("Mon_endTime").toLocalTime() : null);
            avalibility.setTue_startTime(
                    rs.getTime("Tue_startTime") != null ? rs.getTime("Tue_startTime").toLocalTime() : null);
            avalibility
                    .setTue_endTime(rs.getTime("Tue_endTime") != null ? rs.getTime("Tue_endTime").toLocalTime() : null);
            avalibility.setWed_startTime(
                    rs.getTime("Wed_startTime") != null ? rs.getTime("Wed_startTime").toLocalTime() : null);
            avalibility
                    .setWed_endTime(rs.getTime("Wed_endTime") != null ? rs.getTime("Wed_endTime").toLocalTime() : null);
            avalibility.setThu_startTime(
                    rs.getTime("Thu_startTime") != null ? rs.getTime("Thu_startTime").toLocalTime() : null);
            avalibility
                    .setThu_endTime(rs.getTime("Thu_endTime") != null ? rs.getTime("Thu_endTime").toLocalTime() : null);
            avalibility.setFri_startTime(
                    rs.getTime("Fri_startTime") != null ? rs.getTime("Fri_startTime").toLocalTime() : null);
            avalibility
                    .setFri_endTime(rs.getTime("Fri_endTime") != null ? rs.getTime("Fri_endTime").toLocalTime() : null);
            avalibility.setSat_startTime(
                    rs.getTime("Sat_startTime") != null ? rs.getTime("Sat_startTime").toLocalTime() : null);
            avalibility
                    .setSat_endTime(rs.getTime("Sat_endTime") != null ? rs.getTime("Sat_endTime").toLocalTime() : null);
            avalibility.setSun_startTime(
                    rs.getTime("Sun_startTime") != null ? rs.getTime("Sun_startTime").toLocalTime() : null);
            avalibility
                    .setSun_endTime(rs.getTime("Sun_endTime") != null ? rs.getTime("Sun_endTime").toLocalTime() : null);
            return avalibility;
        }
    }
}
